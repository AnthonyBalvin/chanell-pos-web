...
export const NotificationProvider = ({ children }) => {
    ...
    return (
        <UIContext.Provider value={{ notify, confirm }}>
            ...
            {/* CAMBIO AQUÍ: Se cambió top-6 por top-24 para bajar las alertas */}
            <div className="fixed top-24 right-6 lg:right-8 z-[9999] flex flex-col gap-3 pointer-events-none">
                {toasts.map(t => (
                    <div
                        key={t.id}
                    ...
                    <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-[400px] overflow-hidden animate-in zoom-in-95 fade-in duration-300">
                        ...
                        <div className="p-4 sm:px-8 sm:py-5 bg-slate-50/80 border-t border-slate-100 flex flex-col-reverse sm:flex-row items-center justify-center gap-3">
                            ...
                            <button
                                ...
                                className={`w-full sm:w-auto px-5 py-2.5 rounded-xl text-sm font-bold text-white transition-all shadow-sm hover:shadow-md ${confirmState.isDestructive
